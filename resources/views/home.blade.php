                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-center mb-0">
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient2.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient3.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient4.jpg" alt="User Image"></a>
                                    ...
                                    <tr>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient5.jpg" alt="User Image"></a>
